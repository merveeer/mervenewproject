...
/*function getRequestDetail($conn,$request_id)
{
    $sql = "select * from request_detail where request_id=$request_id ";
    $result_query = mysqli_query($conn, $sql);
    while($request_detail = mysqli_fetch_array($result_query,MYSQLI_ASSOC)){
        $ = $request_detail['department_name'];
    }
...
>
							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									...
									<table class="kt-datatable" id="html_table" width="100%">
										<thead>
											<tr>
												<th title="Field #2">Kategori Adı</th>
												<th title="Field #3">Kalem Adı</th>
												<th title="Field #4">Miktar</th>
												<th title="Field #5">Birim</th>
												<th title="Field #7">Durumu</th>
											</tr>
										</thead>
										<tbody>
										<tr>
		...
		<script src="../assets/app/custom/general/crud/metronic-datatable/base/html-table.js" type="text/javascript"></script>
